...
\begin{figure}[ht!]
    \includegraphics[width=16cm]{plots/inkscape_finalImg/schematic1.png}
    \centering
...
\begin{figure}[ht!]
    \includegraphics[width=16cm]{supplementary_info/plots/binom.png}
    \centering
...
\begin{figure}[ht!]
    \includegraphics[width=16cm]{plots/inkscape_finalImg/pedigree_both.png}
    \centering
...
\begin{figure}[ht!]
    \includegraphics[width=16cm]{supplementary_info/plots/readplot_sub.png}
    \centering
...
\begin{figure}[ht!]
    \includegraphics[width=16cm]{supplementary_info/plots/contam0_inbred1_run57_coverage0.2_asc0_inputMode_hapProbs_fil0_pair0_15_relid_emissions_bnds.png}
    \centering
...
\begin{figure}[ht!]
    \includegraphics[width=16cm]{supplementary_info/plots/contam0_inbred1_run57_coverage0.2_asc0_inputMode_hapProbs_fil0_pair0_15_relid_betaplot1.png}
    \centering
...
\begin{figure}[ht!]
    \includegraphics[width=16cm]{supplementary_info/plots/contam0_inbred1_run57_coverage0.2_asc0_inputMode_hapProbs_fil0_ind0_forced_roh.png}
     \centering
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=16cm]{plots/plotimg/plot_IBDaccuracy_others_supp.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=16cm]{supplementary_info/plots/lcPlot.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=16cm]{supplementary_info/plots/egplot1.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=16cm]{supplementary_info/plots/egplot2.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=16cm]{supplementary_info/plots/contam_missspecification.png}
