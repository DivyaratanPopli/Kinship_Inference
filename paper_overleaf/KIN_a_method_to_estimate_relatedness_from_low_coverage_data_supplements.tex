...
\begin{figure}[h]
    ...
    \caption{False positive and true positive rates as a function of incorrect contamination estimates provided to KINgaroo. Dashed vertical line represents true contamination (2.5\%) in simulations, and dotted horizontal line in top panel represents $5\%$ false positive rate.}
    \label{figS10:cnt}
\end{figure}
