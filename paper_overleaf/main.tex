...
\begin{figure}[ht!]
    \includegraphics[width=16.5cm]{pl}
    \centering
...
\begin{figure}[ht!]
    \includegraphics[width=16.5cm]{plot_IBDaccuracy.png}
    \centering
...
\begin{figure}[ht!]
    \includegraphics[width=16.5cm]{comparison_plot.png}
    \centering
...
\begin{figure}[ht!]
    \includegraphics[width=16.5cm]{kinplot.png}
    \centering
