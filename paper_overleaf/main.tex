...
\begin{figure}[htp]
    ...
    \caption{Beta binomial distribution is a better fit compared to Binomial for proportion of difference in windows}
    \label{figS1}
\end{figure}

- Variances are proportional to mean

- READ with Chagyrskaya

\begin{figure}[htp]
    \centering
    \includegraphics[width=18cm]{supplementary_info/plots/fil0_read_plot.png}
    \caption{Application of READ on Neandertal specimens from Chagyrskaya. Color of a square represents the relatedness, while the number denotes loglikelihood ratio.}
    \label{figS2}
\end{figure}

-effect of bounding variance on emission. Here is an identical pair, with identical model transitions with and without variance constraints
\begin{figure}[htp]
    \centering
    ...
    \caption{Emission with bnds}
    \label{figS3}
\end{figure}

-effect of bounding variance on beta. Here is an identical pair, with identical model transitions with and without emissions
\begin{figure}[htp]
    \centering
    ...
    \caption{beta with bnds}
    \label{figS3}
\end{figure}

\begin{figure}[htp]
    \centering
    \includegraphics[width=18cm]{supplementary_info/plots/contam0_inbred1_run57_coverage0.2_asc0_inputMode_hapProbs_fil0_pair0_15_reli
    \caption{beta with bnds}
    \label{figS3}
\end{figure}
...
\begin{figure}[htp]
    ...
    \caption{Application of lcMLkin on Neandertal specimens from Chagyrskaya.}
    \label{figS4}
\end{figure}

-2nd degree with 10M windows
\begin{figure}[htp]
    \centering
