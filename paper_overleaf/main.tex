...
We use simulations both for estimating the transition matrices for all our models, and for testing and validating our algorithm. All simulations are performed using \textt{msprime} \cite{kelleher_efficient_2016}, followed by formation of related individuals using a predetermined pedigree (Figure S\ref{figS10:pedigree}).
