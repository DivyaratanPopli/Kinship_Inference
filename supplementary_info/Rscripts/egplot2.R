...
egplot2 <- function(p1f, datadf, datatf, chrmf, outimg){
...
egplot2(p1f=snakemake@input[["p1f"]], datadf=snakemake@input[["datadf"]], datatf=snakemake@input[["datatf"]], chrmf=snakemake@input[["chrmf"]], outimg=snakemake@output[["outimg"]])
