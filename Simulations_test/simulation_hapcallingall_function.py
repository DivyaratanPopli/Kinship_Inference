...
def get_recomb_pedsim(ibdf, chr_i=13):

    ibd=pd.read_csv(ibdf, sep="\t", header=None,index_col=False)[[2,3,4]]

    ibd_chr=ibd.loc[ibd[2]==chr_i,:]
    ibd_chr.loc[:,4] = ibd_chr.loc[:,4] + 1
    recomb = np.unique(ibd_chr[[3,4]].values)
    recomb[-1] -= 1
    recomb = recomb - recomb[0]

    return recomb

def get_recomb(ibdf_male, ibdf_female):

        recomb_interval1 = get_recomb_pedsim(ibdf=ibdf_male)
        recomb_no1 = len(recomb_interval1) - 2

        recomb_interval2 = get_recomb_pedsim(ibdf=ibdf_female)
        recomb_no2 = len(recomb_interval2) - 2
...
def postSim(genfile,
    ...
    a00=1-10/l
    a11=1-2/l
    for ind in range(int(unrelated/2)):
        hbd_state=make_inbred(len_file=l,a00=a00,a11=a11)

        ch1=2*ind
        ch2=(2*ind)+1

        gen_un[hbd_state==0,ch1]=gen_un[hbd_state==0,ch2] #here always ch1 is replaced by ch2 in hbd region
        gen_i[:,0:(unrelated)]=gen_un
        hbdall_i[:,ind]=hbd_state
    ...
    [no1_c1_12, interv1_c1_12, no2_c1_12, interv2_c1_12]=get_recomb(ibdf_male=ibdfiles[0], ibdf_female=ibdfiles[7])
    [no1_c2_23, interv1_c2_23, no2_c2_23, interv2_c2_23]=get_recomb(ibdf_male=ibdfiles[1], ibdf_female=ibdfiles[8])
    [no1_c3_23, interv1_c3_23, no2_c3_23, interv2_c3_23]=get_recomb(ibdf_male=ibdfiles[2], ibdf_female=ibdfiles[9])
    [no1_c4_45, interv1_c4_45, no2_c4_45, interv2_c4_45]=get_recomb(ibdf_male=ibdfiles[3], ibdf_female=ibdfiles[10])
    [no1_gc1_1011, interv1_gc1_1011, no2_gc1_1011, interv2_gc1_1011]=get_recomb(ibdf_male=ibdfiles[4], ibdf_female=ibdfiles[11])
    [no1_ggc1_512, interv1_ggc1_512, no2_ggc1_512, interv2_ggc1_512]=get_recomb(ibdf_male=ibdfiles[5], ibdf_female=ibdfiles[12])
    [no1_gggc1_613, interv1_gggc1_613, no2_gggc1_613, interv2_gggc1_613]=get_recomb(ibdf_male=ibdfiles[6], ibdf_female=ibdfiles[13])
    ...
    gen_i[:,c1_12[0]], gen_i[:,c1_12[1]], x1_12_1,x1_12_2, rec1_12_1, rec1_12_2= make_baby(gen=gen_i, pos=pos, parent1=p1, parent2=p2,recomb_no1=no1_c1_12, recomb_interval1=interv1_c1_12, recomb_no2=no2_c1_12, recomb_interval2=interv2_c1_12, x1=x1_12_1, x2=x1_12_2)
    gen_i[:,c2_23[0]], gen_i[:,c2_23[1]], x2_23_1,x2_23_2, rec2_23_1, rec2_23_2= make_baby(gen=gen_i, pos=pos, parent1=p2, parent2=p3,recomb_no1=no1_c2_23, recomb_interval1=interv1_c2_23, recomb_no2=no2_c2_23, recomb_interval2=interv2_c2_23, x1=x2_23_1, x2=x2_23_2)
    gen_i[:,c3_23[0]], gen_i[:,c3_23[1]], x3_23_1,x3_23_2, rec3_23_1, rec3_23_2= make_baby(gen=gen_i, pos=pos, parent1=p2, parent2=p3,recomb_no1=no1_c3_23, recomb_interval1=interv1_c3_23, recomb_no2=no2_c3_23, recomb_interval2=interv2_c3_23, x1=x3_23_1, x2=x3_23_2)
    gen_i[:,c4_45[0]], gen_i[:,c4_45[1]], x4_45_1,x4_45_2,rec4_45_1, rec4_45_2= make_baby(gen=gen_i, pos=pos, parent1=p4, parent2=p5,recomb_no1=no1_c4_45, recomb_interval1=interv1_c4_45, recomb_no2=no2_c4_45, recomb_interval2=interv2_c4_45, x1=x4_45_1, x2=x4_45_2)
    gen_i[:,gc1_1011[0]], gen_i[:,gc1_1011[1]],x1c_1011_1,x1c_1011_2, regc1_1011_1, regc1_1011_2= make_baby(gen=gen_i, pos=pos, parent1=c3_23, parent2=c4_45,recomb_no1=no1_gc1_1011, recomb_interval1=interv1_gc1_1011, recomb_no2=no2_gc1_1011, recomb_interval2=interv2_gc1_1011, x1=x1c_1011_1, x2=x1c_1011_2)
    gen_i[:,ggc1_512[0]], gen_i[:,ggc1_512[1]],x1c_512_1,x1c_512_2, regc1_512_1, regc1_512_2= make_baby(gen=gen_i, pos=pos, parent1=gc1_1011, parent2=p6,recomb_no1=no1_ggc1_512, recomb_interval1=interv1_ggc1_512, recomb_no2=no2_ggc1_512, recomb_interval2=interv2_ggc1_512, x1=x1c_512_1, x2=x1c_512_2)
    gen_i[:,gggc1_613[0]], gen_i[:,gggc1_613[1]],x1c_613_1,x1c_613_2, regc1_613_1, regc1_613_2= make_baby(gen=gen_i, pos=pos, parent1=ggc1_512, parent2=p7,recomb_no1=no1_gggc1_613, recomb_interval1=interv1_gggc1_613, recomb_no2=no2_gggc1_613, recomb_interval2=interv2_gggc1_613, x1=x1c_613_1, x2=x1c_613_2)
    ...
    gen_i[:,(unrelated+related):(unrelated+related+identical)]=gen_i[:,0:identical]
    ...
    Dip_i=pd.DataFrame(
            data=gen_i,
            index=np.array(range(0,np.shape(gen_i)[0])),
            columns=np.array(range(0,np.shape(gen_i)[1]))
            )

    with pd.option_context('display.max_rows', len(Dip_i.index), 'display.max_columns', len(Dip_i.columns)):
                Dip_i.to_csv(diploid_sim_i, sep=',')

    np.savetxt(fname=out_hbdall_i, X=hbdall_i, delimiter=",")
