...
def hmm(dfile, tfile, ind, chrmf, p1file, gammafile, resfile, likfile, upA):
    ...
    if win>40:              #if number of windows with nonzero count
        gamma,A,B,lik,pi= baum_welch(data=data, A=A, B=B, pos=pos, p1avg=initial_p, log_bscale=log_bscale, x0=x0, highdiff=highdiff)
