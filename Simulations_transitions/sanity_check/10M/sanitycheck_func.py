...
def plot_gp(length, interval,rdir,g1,g2,p1,p2,outstate,rel23, ninds):
...
def plot_sib(length, interval,rdir,p11,p12,p21,p22,outstate, ninds, rel):
...
def plot_halfsib(length, interval, rdir,outstate, ninds):
