...
def hmm(difffile, targets, totalfile, listind, listf, pfile, Afiles, resfiles, likfile, pairf1, pairf2, instates, p1thresh, thresh, rels):
...
#    pair2.loc[pair2['g_noin']>0.5,'g_noin']=1
    ...
    for rel_cnt in range(len(rels)):
        ...
        resall[gudwin]=res
        likall.append(lik)
        np.savetxt(fname=resfiles[rel_cnt], X=resall,delimiter=',')
