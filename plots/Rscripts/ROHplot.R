...
ROH_plot <- function(infile,outfile){
  ...
  panel<-plot_grid(panel11,panel12,panel21,panel22,panel31,panel32,panel41,panel42, labels= c(" "," "," "," "," "," "," "," "), ncol=1, rel_widths = c(1,1,1,1,1,1,1,1), rel_heights =  c(1,1,1,1,1,1,1,1), align="v")
  panel
